 ...
 * sage pastel gradient, slow-drifting cloud washes, paper grain, and a light vignette.
 */
export function SkyBackground() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden" aria-hidden="true">
      ...
      <div className="animate-drift-a absolute top-1/3 left-[-20%] h-72 w-[90%] rounded-full opacity-40 blur-3xl [background:radial-gradient(closest-side,rgba(214,225,213,0.55),rgba(214,225,213,0))]" />
