...
/**
 * Complete hand-painted icon set for Sara's Birdhouse.
 *
 * Every glyph shares the same warm-ink stroke and soft pastel wash so the
 * whole system reads as pages from one botanical sketchbook, never a
 * generic icon pack.
 */
...
export function MenuIcon(props: IconProps) {
  return (
    <IconBase wash="none" {...props}>
      <path d="M4.5 7.2h15" />
      <path d="M4.5 12h15" />
      <path d="M4.5 16.8h9.5" />
    </IconBase>
  );
}
...
export function ShareIcon(props: IconProps) {
  return (
    <IconBase wash="none" {...props}>
      <circle cx="18" cy="6.2" r="2" />
      <circle cx="6" cy="12" r="2" />
      <circle cx="18" cy="17.8" r="2" />
...
export function BirdIcon(props: IconProps) {
  return (
    <IconBase wash="dustyBlue" {...props}>
      ...
      <circle cx="14.5" cy="9.6" r="0.5" fill="currentColor" />
    </IconBase>
  );
}
...
export function FeatherIcon(props: IconProps) {
  return (
    <IconBase wash="dustyBlue" {...props}>
      <path d="M18.5 4.5c-6 .3-11 4.4-11.8 10.6-.2 1.6.7 3 2.2 3.2C15 19 19 14 19.3 8c.1-1.2.1-2.4-.8-3.5Z" />
      <path d="M12.5 18.5 5.5 21" />
      <path d="M14 8.6 9.6 12M15.8 11.4l-4.6 3.6" />
    </IconBase>
  );
}
...
export function CloudOfflineIcon(props: IconProps) {
  return (
    <IconBase wash="dustyBlue" {...props}>
      <path d="M7.5 16.5a3.6 3.6 0 0 1-.6-7.1 4.6 4.6 0 0 1 8.8-1.6 3.8 3.8 0 0 1-.5 8.7Z" />
      <path d="M9.5 12.5 14.5 12.5" strokeDasharray="0.1 3" />
    </IconBase>
  );
}
